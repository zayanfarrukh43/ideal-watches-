...
const Footer = ({ bgColor = "bg-zinc-950" }) => {
  // Navigation / Quick Links Configuration
  const quickLinks = [
    { label: "Home", path: "/" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-12 border-b border-zinc-900">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 text-xs font-light text-zinc-400" style={{ fontFamily: "Montserrat, sans-serif" }}>
              <Link to="/boutiques/karachi" className="block group">
                ...
                <p className="text-[11px] text-zinc-500 group-hover:text-zinc-400 leading-normal pt-1">
                  Shop # 16, Cafe George Market, Abdullah Haroon Road, Saddar, Karachi
                </p>
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2.5 text-xs font-light text-zinc-400" style={{ fontFamily: "Montserrat, sans-serif" }}>
              <a href="tel:+923162839665" className="flex items-center gap-2 text-zinc-300 hover:text-[#D4AF37] transition-colors">
                <FaPhoneAlt className="text-[#D4AF37] text-[10px]" />
                <span>+92 316 2839665</span>
              </a>
              <a href="https://wa.me/923162839665" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-300 hover:text-emerald-400 transition-colors">
